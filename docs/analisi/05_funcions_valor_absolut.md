...
L'objectiu d'aquest apartat és aprendre a transformar una funció en valor absolut (o que conté un valor absolut) en una **funció definida a trossos**. Això és essencial per poder operar, derivar o representar la funció amb facilitat.
