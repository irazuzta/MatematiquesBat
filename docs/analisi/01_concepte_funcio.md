...
>  
> ![Domini i recorregut](../img/analisi/exemple_taxi.svg){width=60%}  
...
>![Domini i recorregut](../img/analisi/domini_recorregut.svg){width=65%}  
...
> 
> ![Domini i recorregut](../img/analisi/imatge_constant.svg){width=65%}